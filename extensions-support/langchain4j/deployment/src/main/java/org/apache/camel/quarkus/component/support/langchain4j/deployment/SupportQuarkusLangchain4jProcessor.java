...
class SupportQuarkusLangchain4jProcessor {
     ...
     * <li><b>Auto-detection</b> — when no config entries exist, exactly one EmbeddingStore and one
     * EmbeddingModel are present, and no RetrievalAugmentor exists yet, a default one is produced.</li>
     * </ul>
     */
    @BuildStep
    @Record(ExecutionTime.RUNTIME_INIT)
