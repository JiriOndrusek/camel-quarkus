 ...
 */
public final class KeyPairGeneratorRegistrationBuildItem extends MultiBuildItem {

    private final List<String> cipherTransformations;

    public KeyPairGeneratorRegistrationBuildItem(List<String> cipherTransformations) {
