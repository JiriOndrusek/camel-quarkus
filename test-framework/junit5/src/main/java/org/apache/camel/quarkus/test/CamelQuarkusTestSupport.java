...
public class CamelQuarkusTestSupport extends CamelTestSupport
     ...
     */
    @Override
    public final boolean isUseRouteBuilder() {
    ...
    /**
     * This method does nothing. The context started together with Quarkus engine.
     */
    @Override
    ...
    /**
     * Internal method for getting flag from the {@link CamelQuarkusTestSupport} instance.
     */
    final boolean isWasUsedRouteBuilder() {
        return wasUsedRouteBuilder;
    }
}
