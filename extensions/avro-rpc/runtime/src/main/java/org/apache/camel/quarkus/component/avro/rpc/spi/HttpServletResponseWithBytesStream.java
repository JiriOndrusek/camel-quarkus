 ...
 */
public class HttpServletResponseWithBytesStream implements HttpServletResponse {

    private BAOSServletOutputStream baos = new BAOSServletOutputStream();

    public byte[] getBytes() {
        return baos.getBaos().toByteArray();
    }
    ...
    private class BAOSServletOutputStream extends ServletOutputStream {
