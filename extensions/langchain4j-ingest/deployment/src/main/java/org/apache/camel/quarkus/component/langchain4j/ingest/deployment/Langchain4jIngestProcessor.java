...
class Langchain4jIngestProcessor {
     ...
     * initialized at run time and its font metrics, glyph lists and ICC profile embedded —
     * mirroring the camel-quarkus-pdf extension's registrations, widened to the rendering and
     * graphics packages that Tika's text extraction reaches and camel-pdf does not. Produced
