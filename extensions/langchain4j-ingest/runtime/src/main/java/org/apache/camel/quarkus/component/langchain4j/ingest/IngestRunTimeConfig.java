...
public interface IngestRunTimeConfig {
    ...
    interface PipelineRunTimeConfig {
        ...
        interface SourceRunTimeConfig {
            ...
            /**
             * Name of the `IdempotentRepository` bean backing the duplicate register, instead of
             * the built-in in-memory one (100 000 keys, lost on restart). Looked up by name
             * only. On a pipeline consuming from a component it deduplicates deliveries by
             * document id, first write wins.
             */
