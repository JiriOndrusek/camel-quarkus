...
public final class IngestPipeline {
    ...
    private String trackerDatasource;
    ...
    /** Name of the datasource backing the sync tracker; the default datasource when unset. */
    public IngestPipeline trackerDatasource(String datasourceName) {
        this.trackerDatasource = datasourceName;
        return this;
    }
    ...
    IngestRunTimeConfig.PipelineRunTimeConfig asRunTimeConfig() {
        ...
        return new IngestRunTimeConfig.PipelineRunTimeConfig() {
            ...
            @Override
            public TrackerRunTimeConfig tracker() {
                return () -> Optional.ofNullable(trackerDatasource);
            }
