...
final class IngestPipelineDefinition {
    ...
    public IngestPipelineDefinition maxDocumentSize(int maxDocumentSize) {
        if (maxDocumentSize < 1) {
            throw new IllegalArgumentException(
                    "Ingestion pipeline '" + name + "': maxDocumentSize must be positive (got "
                            + maxDocumentSize + ")");
        }
    ...
    /** The splitter as an instance; it is bound to the registry under a generated name. */
    public IngestPipelineDefinition documentSplitter(DocumentSplitter splitter) {
    ...
    /** The repository as an instance; it is bound to the registry under a generated name. */
    public IngestPipelineDefinition idempotentRepository(IdempotentRepository repository) {
        this.idempotentRepository = repository;
        return this;
    }
