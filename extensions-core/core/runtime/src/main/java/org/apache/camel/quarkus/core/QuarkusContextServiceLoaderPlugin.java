...
public class QuarkusContextServiceLoaderPlugin extends ServiceSupport implements ContextServiceLoaderPluginResolver {
    private static final Logger LOG = LoggerFactory.getLogger(QuarkusContextServiceLoaderPlugin.class);
