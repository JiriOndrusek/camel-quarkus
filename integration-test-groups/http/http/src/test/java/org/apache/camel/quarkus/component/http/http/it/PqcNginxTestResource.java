...
public class PqcNginxTestResource implements QuarkusTestResourceLifecycleManager {
    ...
    public Map<String, String> start() {
        try {
            ...
            // Get certificate files from PQC certificate generation extension
            // Certificates are generated by @PQCCertificates annotation on the test class
            HybridCertificateFiles certFiles = PQCCertificateGenerationExtension.findCertificateByName(CERT_NAME);
            if (certFiles == null) {
                throw new IllegalStateException(
                        "PQC certificate '" + CERT_NAME
                                + "' not found. Make sure @PQCCertificates annotation generated it.");
            }
