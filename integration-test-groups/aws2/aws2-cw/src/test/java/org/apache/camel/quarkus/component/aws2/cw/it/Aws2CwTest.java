...
class Aws2CwTest {
    ...
    public void headers() {
        ...
        data.add(CollectionHelper.mapOf(
                ...
                Cw2Constants.METRIC_UNIT, "Count",
                Cw2Constants.METRIC_TIMESTAMP, Instant.ofEpochMilli(System.currentTimeMillis() - 24 * 60 * 60 * 10000),
                Cw2Constants.METRIC_DIMENSION_NAME, "type",
                Cw2Constants.METRIC_DIMENSION_VALUE, "odd"));

        data.add(CollectionHelper.mapOf(
                Cw2Constants.METRIC_NAMESPACE, namespace + "wrong", Cw2Constants.METRIC_NAME, metricName,
    ...
    public void customClient() {
        ...
        RestAssured.given()
                ...
                .then()
                .statusCode(200)
                .body(is("Custom client exception"));
    }
