...
class AzureKeyVaultTest {
    ...
    @EnabledIfEnvironmentVariable(named = "AZURE_VAULT_REFRESH_EVENT_HUBS_NAME", matches = ".+")
    ...
    void contextRefresh() {
        ...
        try {
            ...
            try (EventHubProducerClient client = new EventHubClientBuilder()
                    .connectionString(System.getenv("AZURE_EVENT_HUBS_CONNECTION_STRING"))
                    .eventHubName(System.getenv("AZURE_VAULT_REFRESH_EVENT_HUBS_NAME"))
                    .buildProducerClient()) {
            ...
            try {
                String connectionString = System.getenv("AZURE_EVENT_HUBS_CONNECTION_STRING");
                ...
                LOG.info("Failed to clear event hub " + System.getenv("AZURE_VAULT_REFRESH_EVENT_HUBS_NAME"), e);
            }
