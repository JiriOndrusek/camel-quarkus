...
| xref:extensions/debezium-mongodb.adoc[Debezium MongoDB Connector] | camel-quarkus-debezium-mongodb | Native + Stable | 1.0.0-CR2 | Capture changes from a MongoDB database.
