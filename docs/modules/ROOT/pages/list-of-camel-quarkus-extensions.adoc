...
// components: START
Number of Camel components: 154 in 119 JAR artifacts (0 deprecated)
...
| xref:extensions/cassandraql.adoc[Cassandra CQL] | camel-quarkus-cassandraql | Native + Stable | 1.0.0-CR4 | Integrate with Cassandra 2.0 using the CQL3 API (not the Thrift API).
