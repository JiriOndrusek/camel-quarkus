...
| xref:extensions/aws2-eks.adoc[AWS 2 EKS] | camel-quarkus-aws2-eks | Native + Stable | 1.0.0-M6 | Manage AWS EKS cluster instances using AWS SDK version 2.x.
...
| xref:extensions/tika.adoc[Tika] | camel-quarkus-tika | Native + Stable | 1.0.0-M6 | Parse documents and extract metadata and text using Apache Tika.
