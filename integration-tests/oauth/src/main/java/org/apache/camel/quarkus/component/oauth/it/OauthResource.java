...
public class OauthResource {
    ...
    public Response post(String message) throws Exception {
        LOG.infof("Sending to oauth: %s", message);
        final String response = producerTemplate.requestBody("oauth:--fix-me--", message, String.class);
        LOG.infof("Got response from oauth: %s", response);
        return Response
