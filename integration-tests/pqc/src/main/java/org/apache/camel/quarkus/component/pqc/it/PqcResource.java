...
public class PqcResource {
    ...
    public String encapsulate(@PathParam("algorithm") String algorithm) {
        SecretKeyWithEncapsulation secretKeyWithEncapsulation = producerTemplate.requestBody(
                "pqc:encapsulate?operation=generateSecretKeyEncapsulation&keyEncapsulationAlgorithm=%s&symmetricKeyAlgorithm=AES&symmetricKeyLength=128&keyPair=%s".formatted(algorithm, toKeyPair(algorithm)),
                null,
