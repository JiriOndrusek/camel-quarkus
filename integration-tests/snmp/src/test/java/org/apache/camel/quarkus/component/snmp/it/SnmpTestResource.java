...
public class SnmpTestResource implements QuarkusTestResourceLifecycleManager {
    ...
    public Map<String, String> start() {
        ...
        try {
            UdpAddress a = new UdpAddress(LOCAL_ADDRESS);
            System.out.println(">>>>>>>>>>>> get InetAddress:" + a.getInetAddress());
            System.out.println(">>>>>>>>>>>> get Port:" + a.getPort());
            udpTransportMapping = new DefaultUdpTransportMapping(a);
