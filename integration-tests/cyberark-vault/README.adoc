...
The tests able to run against docker by default.

The docker environment is not started when all configuration is provided via environmental properties.
...
* Upload policy from test resources
