...
public class MinioTestResource implements QuarkusTestResourceLifecycleManager {
    ...
    public Map<String, String> start() {
        container = new GenericContainer<>("minio/minio:RELEASE.2024-11-07T00-52-20Z")
        ...
        return Map.of(
                ...
                "quarkus.camel.ai.ingest.s3docs.source.access-key", USER,
                "quarkus.camel.ai.ingest.s3docs.source.secret-key", PASSWORD,
                "quarkus.camel.ai.ingest.s3docs.source.endpoint-override", endpoint);
    }
