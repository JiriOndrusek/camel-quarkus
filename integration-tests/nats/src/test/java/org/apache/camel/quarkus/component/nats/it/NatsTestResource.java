...
//    private static final String NATS_IMAGE = ConfigProvider.getConfig().getValue("nats.container.image", String.class);
    ...
    private static GenericContainer<?> tlsAuthContainer(Map<String, String> properties) {
        ...
        GenericContainer<?> container = new GenericContainer<>(NATS_IMAGE)
                ...
                .withClasspathResourceMapping("ssl/nats-ca.crt", "/certs/nats-ca.crt", BindMode.READ_ONLY,
                        SelinuxContext.SHARED)
                .withClasspathResourceMapping("ssl/nats.key", "/certs/nats.key", BindMode.READ_ONLY, SelinuxContext.SHARED)
                .withClasspathResourceMapping("ssl/nats.crt", "/certs/nats.crt", BindMode.READ_ONLY,
                        SelinuxContext.SHARED)
