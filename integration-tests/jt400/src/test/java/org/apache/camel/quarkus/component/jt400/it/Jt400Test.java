...
public class Jt400Test {
    ...
    public void testReadKeyedDataQueue() {
        ...
        prepareMockReply(Jt400Resource.ReplyType.request, CollectionHelper.mapOf("keyLength", 5));
        prepareMockReply(Jt400Resource.ReplyType.ok);
    ...
    public void testWriteKeyedDataQueue() {
        prepareMockReply(Jt400Resource.ReplyType.ok);
        prepareMockReply(Jt400Resource.ReplyType.request, CollectionHelper.mapOf("keyLength", 7));
        prepareMockReply(Jt400Resource.ReplyType.ok);
