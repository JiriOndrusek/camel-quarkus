...
public class AiToolLangchain4jResource {
    ...
    //    private static final Map<String, List<String>> VISIBLE_TOOLS = new ConcurrentHashMap<>();
    ...
    //    @Path("/visible-tools/{service}")
    //    @GET
    //    @Produces(MediaType.TEXT_PLAIN)
    //    public String getVisibleTools(@PathParam("service") String service) {
    //        return String.join(",", VISIBLE_TOOLS.getOrDefault(service, List.of()));
    //    }

    //    public static void recordVisibleTools(String serviceKey, List<ToolSpecification> tools) {
    //        VISIBLE_TOOLS.put(serviceKey, tools.stream()
