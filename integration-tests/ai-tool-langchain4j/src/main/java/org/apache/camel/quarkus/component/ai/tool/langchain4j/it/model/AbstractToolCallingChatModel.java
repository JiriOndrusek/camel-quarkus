    ...
    public ChatModel get() {
        return new ChatModel() {
            ...
            public ChatResponse doChat(ChatRequest chatRequest) {
                ...
                if (!hasToolResult) {
                    //                    // Test-only: record which tools the framework passed so tag-filtering tests can verify isolation
                    //                    if (chatRequest.toolSpecifications() != null) {
                    //                        AiToolLangchain4jResource.recordVisibleTools(getNameOfService(), chatRequest.toolSpecifications());
                    //                    }
