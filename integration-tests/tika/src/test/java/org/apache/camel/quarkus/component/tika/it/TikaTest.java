...
class TikaTest {
    ...
    @Test
    public void testDetecgtImagePng() throws Exception {
        testDetect("black.png", "image/png");
    }

    //---------------------------------------------------------------------------------------------------------

    private String testParse(String fileName, String expectedContentType, String expectedBody) throws Exception {
        String body = post(fileName, "/tika/parse")
