...
class AiToolTest {
    ...
    void allToolsReturnsEveryRegisteredTool() {
        ...
        org.junit.jupiter.api.Assertions.assertTrue(tools.contains("getWeather"), "Expected getWeather in: " + tools);
        org.junit.jupiter.api.Assertions.assertTrue(tools.contains("calculate"), "Expected calculate in: " + tools);
        org.junit.jupiter.api.Assertions.assertTrue(tools.contains("greet"), "Expected greet in: " + tools);
        org.junit.jupiter.api.Assertions.assertTrue(tools.contains("failingTool"), "Expected failingTool in: " + tools);
    }
    ...
    void toolSchema() {
        ...
        org.junit.jupiter.api.Assertions.assertTrue(schema.contains("\"city\""), "Expected city in schema: " + schema);
        org.junit.jupiter.api.Assertions.assertTrue(schema.contains("\"unit\""), "Expected unit in schema: " + schema);
        org.junit.jupiter.api.Assertions.assertTrue(schema.contains("\"string\""), "Expected string type in schema: " + schema);
    }
