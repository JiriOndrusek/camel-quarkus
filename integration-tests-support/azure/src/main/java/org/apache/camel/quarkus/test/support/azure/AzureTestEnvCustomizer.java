...
public interface AzureTestEnvCustomizer<C extends GenericContainer> {
    ...
    /**
     * Customize the given {@link AzureCloudContext}
     * If the container was created by `createContainer` method, it is already running.
     *
     * @param envContext the {@link AzureCloudContext} to customize
     */
    void customize(AzureCloudContext envContext);
