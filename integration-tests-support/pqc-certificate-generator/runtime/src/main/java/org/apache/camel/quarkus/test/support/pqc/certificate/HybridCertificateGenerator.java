...
public class HybridCertificateGenerator {
    ...
    private X509Certificate buildChimeraCertificate(
        ...
        certBuilder.addExtension(Extension.subjectAltPublicKeyInfo, false, pqcPubKeyInfo);
    ...
    private HybridCertificateFiles exportCertificateFiles(
        ...
        Path keystore = null;
        if (primaryKeyPair != null) {
            keystore = outputDir.resolve(name + "-keystore.p12");
            KeyStore ks = KeyStore.getInstance("PKCS12");
            ks.load(null, null);
            ks.setKeyEntry(name, primaryKeyPair.getPrivate(), password.toCharArray(),
